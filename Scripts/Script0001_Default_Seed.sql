...
(employee_number_fk, yearly_billable_target_hours, current_billable_hours, target_training_hours, current_training_hours, total_yearly_pto, overflow_pto, used_pto, the_year, billable_target_to_date, week_ending_date)
VALUES('0123', 1000, 500, 80, 20, 100, 50, 200, 2020, 100, '1900-01-01');
